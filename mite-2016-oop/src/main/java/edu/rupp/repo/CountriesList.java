...
public class CountriesList {
    ...
    public static void listCountriesByLetter(String letter) {

        Map<String, Set<String>> countriesGrouped = new HashMap<String, Set<String>>();
        countriesGrouped = groupCountriesByLetter();

        if (letter != null) {
            letter = letter.toUpperCase();
            System.out.println("\n--- List countries by alphabet '" + letter + "' ---");
            System.out.println(countriesGrouped.get(letter));
        } else {
            System.out.println("Letter can not be null");
        }
    }

    public static Map<String, Set<String>> groupCountriesByLetter(){
